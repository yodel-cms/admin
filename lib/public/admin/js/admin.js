...
function initialiseHTMLFields() {
  if($('.list').length) {
    ...
    var width = '100%';
    var row1 = 'bold,italic,underline,strikethrough,sub,sup,charmap,|,justifyleft,justifycenter,justifyright,justifyfull,|,formatselect,fontsizeselect,|,bullist,numlist,outdent,indent,blockquote,|,link,unlink,|,table,|,code';
    var row2 = '';
    var row3 = '';
  }
